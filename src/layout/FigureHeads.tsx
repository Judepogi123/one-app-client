        ...
        <TableBody>
          {data.figureHeads.map((item) => (
            <TableRow
              ...
              onClick={() => handleSelectHead(item, index)}
            >
              ...
              {level === 3 ? (
                <TableCell>
                  {item.purokCoors?.voter?.lastname},{" "}
                  {item.purokCoors?.voter?.firstname}
                </TableCell>
              ) : (
                <TableCell>
                  {item.barangayCoor?.voter?.lastname},{" "}
                  {item.barangayCoor?.voter?.firstname}
                </TableCell>
              )}
            </TableRow>
          ))}
